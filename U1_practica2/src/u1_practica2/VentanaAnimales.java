...
public class VentanaAnimales extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Ir a información");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String url = "https://es.wikipedia.org/wiki/Animalia";
        try {
            jEditorPane1.setPage(url);
        } catch (IOException ex) {
            Logger.getLogger(VentanaAnimales.class.getName()).log(Level.SEVERE, null, ex);
        }
